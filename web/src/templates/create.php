    ...
    <div class="basic-page">
        <div class="basic-container">
            ...
            <form class="form" action="?command=submit_event" method="post">
                ...
                <input type="text" class="form-field-large" name="event_name" id="eventName" aria-label="Event Name"
                    required>
                <br>
                <h2 class="field-label-text">Event Description:</h2>
                <textarea class="form-field-para" name="event_description" id="eventDescription"
                    aria-label="Event Description" required> </textarea>
                <h2 class="field-label-text">Event Date:</h2>
                <input type="date" class="form-field-date" name=event_date id="eventDate" aria-label="Event Date"
                    required><br>
                <h2 class="field-label-text">Event Time:</h2>
                <input type="time" class="form-field-time" name="start_time" id="startTime"
                    aria-label="Event Start Time" required>
                <span class="field-label-text">-</span>
                <input type="time" class="form-field-time" name="end_time" id="endTime" aria-label="Event End Time"
                    required><br>
                <h2 class="field-label-text">Event Location:</h2>
                <input type="text" class="form-field-reg" name="event_location" id="location"
                    aria-label="Event Location" required><br>
